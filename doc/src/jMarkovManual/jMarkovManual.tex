...
\lstinputlisting[linerange={202-203,210-224,230-233,238-240,
  246-248,254-256,271-281,294-296}]{\srcbase{QueueMM2dN.java}}
...
\lstinputlisting[linerange={297-338}]{\srcbase{QueueMM2dN.java}}

\subsubsection{Class QueueMM2dN}

For this example we extend \verb"SimpleMarkovProcess". In the following code
illustrate the system implementation with the class
\verb"QueueMM2dN".
